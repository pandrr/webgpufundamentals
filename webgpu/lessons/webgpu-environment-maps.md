...
Based on [the code in the previous article](webgpu-cube-maps.html) let's load those 6 images instead of the canvaes we generated.
...
cube like we covered in [the article on lighting](webgpu-3d-lighting-directional.html)
